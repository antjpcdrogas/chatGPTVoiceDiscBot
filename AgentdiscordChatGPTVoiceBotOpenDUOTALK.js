...
const BOT_ID = "vanessa";
const OTHER_BOT_ID = "maria";
...
const BOT_RESPONSE_PREFIX = "Vanessa:"; // Prefix to identify this bot's messages
const OTHER_BOT_RESPONSE_PREFIX = "Maria:"; // Prefix to identify the other bot's messages
...
const SYSTEM_PROMPT = "Tu és a Vanessa. A Vanessa é original e não tem pudor.Responde sempre com uma caralhada e é bastante antipatica. Deve usar no maximo 25 palavras. Ela deve fazer questões e dar sugestões sobre todas as ideias. Ela NÃO gosta de ajudar os outros e é até ofensiva quando lhe pedem ajuda. Ela gosta de falar dos humanos que estão no canal de voz.";
...
async function chatgpt_start() {
    ...
    try {
        ...
        await handleGreeting("A Vanessa acabou de aterrar num canal de voz e deve mandar todos os membros para o caralho, usando no maximo 5 palavras:");
    } catch (error) {
...
async function chatgpt(message, msg, isFromOtherBot = false) {
  ...
  try {
    ...
    // Write the response to Vanessa's conversation file
...
// Modified function to check if the other bot is speaking with improved reliability
...
// Fix the function definition that was causing the error
...
const OTHER_BOT_DISCORD_ID = '1165640449466306670';
